...
from strategies.macd_agro import run_macd_agro
...
def main():
    ...
    elif strategy == "MACD Agro" or strategy == "4":
        print("Running MACD Agro Strategy...")
        data = run_macd_agro(data)
        run_backtest(data)

    elif strategy == "Buy and Hold" or strategy == "5":
